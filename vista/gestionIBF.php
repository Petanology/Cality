    ...
    <div class="conainer-fluid p-3">
        ...
        <?php if(isset($_POST['boton-consultar'])){ ?>
            ...
            ?>
                ...
                <form name="formGeneral" action="../controlador/gestionIBFControlador.php" method="post" autocomplete="off">
                <p class="rounded-top font-weight-bold pt-3 text-white p-3" style="background-color:#5aa7d6;">Area de Calidad - Formato Calidad In Bound</p>
                ...
                <div class="container-fluid">    
                    ...
                    <table class="table table-borderless table-striped table-secondary mt-3">
                        <tr>
                            <th class="text-white text-center" style="background-color:#5aa7d6;" colspan="3">SERVICIO Y ETIQUETA TELEFÓNICA 
                            <?php 
                        ...
                        <!-- SEGUNDO ITEM -->
                        <tr>
                            <th class="text-white text-center" style="background-color:#5aa7d6;" colspan="3">OBJETO DE LA LLAMADA
                            <?php 
                    ...
                    <hr>
                    <button id="botonRegistrar" type="button" onclick="validarFormatoIBF()" class="shadow btn mb-3 font-weight-bold text-white" style="background-color:#5aa7d6;"><i class="fas fa-plus mr-1"></i> REGISTRAR GESTIÓN</button>
                </div>
            </form>
            </div>
            <?php        
        ...
        <?php } else {?>
            ...
            <div class="container-fluid w-75 text-center">
                ...
                <h2 class="h3 text-white mt-2">una vez consultado el usuario se podrá realizar la gestión de calidad <kbd>in bound financiero</kbd></h2>
            </div>
        <?php } ?>
