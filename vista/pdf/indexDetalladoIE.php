...
?>
    ...
    <div class="container-fluid pt-3">
        <form action="reporteDetalladoIndirectoEstandar.php" method="post">
            <div class="form-group input-group-sm">
                <label for="mes" class="mb-3 w-100 h6 text-white text-center font-weight-bold">INFORME DETALLADO PARA MENSAJE VD</label>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-success btn-sm btn-block"><i class="fas fa-plus-circle"></i> GENERAR ARCHIVO PDF</button>
