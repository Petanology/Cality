...
?>
    ...
    <div class="container-fluid pt-3">
        <form action="reportePromedioIndirectoEstandar.php"  class="bg-dark p-3 rounded" method="GET">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary font-weight-bold btn-sm btn-block"
