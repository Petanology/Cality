<?php
    ...
    class PDFNEG extends FPDF {
        
        public $mes;
        
        function Header(){
            // Fondo Azul
            $this->SetFillColor(84, 153, 199);
            $this->SetXY(0,0);
            ...
            // Titulo principal
            $this->SetFillColor(127, 179, 213);
            $this->SetTextColor(255, 255, 255);
            $this->SetFont('Arial','B',13);
            $this->SetXY(50,7);
            $this->Cell(0,13,"INFORME NEGOCIACION FINANCIERA " . $this->ImprimirMes($this->mes),'LR',0,'C',1);
