<?php
    ...
    $pdf->Cell(25,6,'P.E.P.',0,0,'C',1); 
    $pdf->Cell(24,6,'S. CLIENTE',0,0,'C',1);
    $pdf->Cell(24,6,'NEGOCIACION',0,0,'C',1);
    $pdf->Cell(24,6,'A. DATOS',0,0,'C',1);
    $pdf->Cell(24,6,'R. SISTEMA',0,0,'C',1);
