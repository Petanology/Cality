<?php
    ...
    $sihayInforme = $vResultados->validacionDetalladoIB($_GET["asesorConsulta"] , $_GET["mesReporte"]);
    ...
    // Cerrar PDF 
    $pdf->Close();
    $pdf->Output("I","detallado-inbound-vd-$pdf->asesorConsulta-$pdf->mesReporte.pdf");
