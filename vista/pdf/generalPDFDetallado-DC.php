<?php
    ...
    class PDFDC_D extends FPDF {
        ...
        function Header(){
            ...
            // Titulo principal
            $this->SetFillColor(33, 162, 205);
            $this->SetTextColor(255, 255, 255);
            $this->SetFont('Arial','B',13);
            $this->SetXY(50,7);;
            $this->Cell(0,13,"DETALLADO NEGOCIACION COMERCIAL " . $this->ImprimirMes($this->mesReporte),'LR',0,'C',1);
