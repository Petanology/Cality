        ...
        <form action="retroalimentacionPDF.php" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-2">
                    ...
                    <select name="corte" id="corte" class="input-sm mb-3 form-control">
                ...
                <div class="form-group col-2">
                    ...
                    <input type="number" placeholder="Digite el rango de los últimos días a evaluar" name="ultimosDias" id="ultimosDias" class="input-sm mb-3 form-control">
                </div>

                <div class="form-group col-2">
                    <label for="puntaje" class="text-white font-weight-bold">Nota máxima</label>
                    <input type="number" placeholder="Digite la nota máxima a evaluar" name="puntaje" id="puntaje" class="input-sm mb-3 form-control">
                </div>
            </div>
