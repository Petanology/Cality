<?php
    ...
    $sihayInforme = $vResultados->validacionDetalladoDC($_GET["asesorConsulta"] , $_GET["mesReporte"]);
    ...
    // Cerrar PDF 
    $pdf->Close();
    $pdf->Output("I","detallado-negociacion-comercial-$pdf->asesorConsulta-$pdf->mesReporte.pdf");
        
    }
    else{
        header("location: indexDetalladoDC.php?mensaje=No hay resultado para la busqueda que esta realizando...");
    }
?>