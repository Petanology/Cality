...
<?php 
    ...
    } else if($_SESSION['rol'] == "coord_financiera" || $_SESSION['rol'] == "coord_venta_directa" || $_SESSION['rol'] == "jefe_operaciones" || $_SESSION['rol'] == "lider" || $_SESSION['rol'] == "analista"){
        header("location:acceso_denegado.php");
    }
...
?>
    ...
    <div class="container-fluid">
        ...
        <!-- botón registrar -->
        <button type="button" class="mt-3 mb-3 btn btn-primary font-weight-bold" data-toggle="modal" data-target="#form_coordVentaDirecta1"><i class="fas fa-plus"></i> REGISTRAR COORDINADOR DE VENTA DIRECTA</button>
