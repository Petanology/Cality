...
<?php 
    ...
    if($_SESSION['rol'] == "coord_financiera" || $_SESSION['rol'] == "coord_venta_directa" || $_SESSION['rol'] == "lider" || $_SESSION['rol'] == "analista" || $_SESSION['rol'] == "asesor" || empty($_SESSION['autenticado'])){
    ...
    <div class="container-fluid">
            ...
            <tbody class="table-light">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="submit" name="botonModificar" class="btn btn-success" value="<?php echo $rowA[0]?>" data-toggle="modal" data-target="#form_administrador2"><i class="fas fa-pencil-alt"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            </tbody>
        ...
        <?php
            ...
            if(isset($_POST['botonModificar'])): // traer informacón de item seleccionado
                ...
                $objetoA = new administradorDao(); 
                $listarAdministrador = $objetoA->listarItem($IdbotonModificar);
                
                foreach($listarAdministrador as $rowA):
                    include("modal/mModificarAdministrador.php"); // Modal Modificar 
                endforeach;
            endif;
        ?>
    </div>
