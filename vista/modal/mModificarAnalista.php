<div class="modal fade" id="form_analista2" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Modificar Analista</h5>
            ...
            <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="mb-3 form-control" id="identificacion2" name="identificacion2" placeholder="Digite la identificación" value="<?php echo $rowAna[2]; ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="mb-3 form-control" id="nombres2" name="nombres2" placeholder="Digite el nombre" value="<?php echo $rowAna[3]; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="mb-3 form-control" id="apellidos2" name="apellidos2" placeholder="Digite los apellidos" value="<?php echo $rowAna[4]; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            ?>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="genero2" id="genero2<?php echo $rowG[0]; ?>" value="<?php echo $rowG[0]; ?>" class="custom-control-input" <?php if($rowAna[5]==$rowG[0]){echo "checked";} ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="mb-3 form-control" id="correo2" name="correo2" placeholder="Digite el correo electrónico" value="<?php echo $rowAna[7]; ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="mb-3 form-control" id="usuario2" name="usuario2" placeholder="Digite un usuario de sesión" value="<?php echo $rowAna[8]; ?>">
