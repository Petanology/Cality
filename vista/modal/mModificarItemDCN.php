<div class="modal fade" id="form_itemDCN2" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Modificar Item de Negociación  - formato venta directa comercial</h5>
            ...
            <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $rowLI[1]; ?>" class="form-control" id="nombre2" name="nombre2" placeholder="Digite el nuevo item">
                        </div>
