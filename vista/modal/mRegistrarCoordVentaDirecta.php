...
?>
   ...
   <div class="modal fade" id="form_coordVentaDirecta1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Registrar Coordinador de Venta Directa</h5>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <form id="formRegistro" name="formRegistro" action="../controlador/coordVentaDirectaControlador.php" method="post" enctype="multipart/form-data"  autocomplete="off">
