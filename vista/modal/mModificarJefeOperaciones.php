<div class="modal fade" id="form_jefe_operaciones2" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Modificar Jefe de Operaciones</h5>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <form action="../controlador/jefeOperacionesControlador.php" method="post"  autocomplete="off">
