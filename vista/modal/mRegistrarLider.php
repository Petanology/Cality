...
?>
   ...
   <div class="modal fade" id="form_lider1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formRegistro" name="formRegistro" action="../controlador/liderControlador.php" method="post" enctype="multipart/form-data"  autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            ?>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="genero" id="genero<?php echo $rowG[0]; ?>" value="<?php echo $rowG[0]; ?>" class="custom-control-input" required>
