...
?>
   <div class="modal fade" id="form_jefe_operaciones1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold">Registrar Jefe de operaciones</h5>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <form id="formRegistro" name="formRegistro" action="../controlador/jefeOperacionesControlador.php" method="post" enctype="multipart/form-data"  autocomplete="off">
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tipoDocumento" id="tipoDocumento" class="mb-3 form-control" required>
                                ...
                                <?php
                                    ...
                                    $formTipoDocAdmin = $objetoTDAdmin->formTipoDoc();
                                    foreach($formTipoDocAdmin as $rowFTDAdmin):                
                                ?>
                                <option value="<?php echo $rowFTDAdmin[0]; ?>"><?php echo $rowFTDAdmin[1]; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <?php
                                $objetoGAdmin = new generoDao();
                                $formGeneroAdmin = $objetoGAdmin->formGenero();
