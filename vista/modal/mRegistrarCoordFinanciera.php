...
?>
   ...
   <div class="modal fade" id="form_coordFinanciera1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formRegistro" name="formRegistro" action="../controlador/coordFinancieraControlador.php" method="post">
