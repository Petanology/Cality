...
?>
    ...
    <div class="conainer-fluid p-3">
        <!-- PRIMERA SECCION -->
        <div class="container-fluid rounded bg-white border border-danger text-dark">
            <form action="" method="post" name="formBusqueda" autocomplete="off">
                <h6 class="pt-3 pb-2 font-weight-bold">Búsqueda de asesores</h6> 
        ...
        <?php if(isset($_POST['boton-consultar'])){ ?>
            ...
            <?php 
                ...
                $oGestionesAsesorDao = new asesorDao();
                $siHayGestionesUsuario = $oGestionesAsesorDao->saberGestionesUsuario($aIngresado);
                $ejemplo1 = null;
                foreach($siHayGestionesUsuario as $rowSGU){
                    $ejemplo1 = $rowSGU;
                }
                if(isset($ejemplo1)){
            ?>
            ...
            ?>
                ...
                <div class="container-fluid w-75 text-center">
                    <img src="img/busqueda-error-2.png" width="350" class="mt-2 mb-0" alt="icono de búsqueda">
