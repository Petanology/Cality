    ...
    <div class="container-fluid">
            ...
            <tbody class="table-light">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="submit" name="botonModificar" class="btn btn-success" value="<?php echo $rowA[0]?>" data-toggle="modal" data-target="#form_analista2"><i class="fas fa-pencil-alt"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
            </tbody>
        ...
        <?php
            ...
            if(isset($_POST['botonModificar'])): // traer informacón de item seleccionado
                ...
                $objetoA = new analistaDao(); 
                $listarAnalista = $objetoA->listarItem($IdbotonModificar);
                
                foreach($listarAnalista as $rowAna):
                    include("modal/mModificarAnalista.php"); // Modal Modificar 
                endforeach;
            endif;
        ?>
    </div>
