    ...
    <div class="conainer-fluid p-3">
        ...
        <?php } else {?>
            ...
            <div class="container-fluid w-75 text-center">
                ...
                <h2 class="h3 text-white mt-2">una vez consultado el usuario se podrá realizar la gestión de calidad <kbd class="bg-info">mensaje</kbd></h2>
            </div>
        <?php } ?>
