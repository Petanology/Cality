<?php
    ...
    class loginControlador{
        ...
        public function __construct(){
            ...
            } else if($rolForm == "jefe_operaciones"){
                // Se llama el metodo de iniciar sesión especial para jefe operaciones debido a que la tabla de la base de datos toene un "_"
                $rlogin = $loginDao->loginJefeOperaciones($usuarioForm,$contraForm);
                if(empty($rlogin)){
                    $this->mensaje = "Por favor verifique los datos ingresados...";
                    header("location: ../vista/index.php?m=$this->mensaje&usu=$usuarioForm&rol=$rolForm");
                }else{
